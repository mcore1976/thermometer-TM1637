/**
 * Termometr na TM36 od -50 do 100st z obsluga wyswietlania na module TM1637
 * pierwotnie program obslugiwal LM35 roznica to wartość konwersji o 500 wyzsza
 * dla TM36 i ja trzeba odjac 
*/
...
int main(void)
{
	...
	while (1) {
       ...
       temp = temp >> 4;
        ...
        // 
        //  wartosc odczytana z TM36 jest o 500 wieksza od LM35
	//  jesli jest ponizej 500 to jest ujemna temperatura
        //  	

		if (temp > 499) {
			temp = temp - 500;
                // wyswietlenie znaku stopni jesli temperatura dodatnia
                        TM1637_display_segments(3, 99);

		} else 
                  {
                // wyswietlenie znaku MINUS i przeliczenie temperatury na ujemna
